...
public class EntityArrowPoison extends CustomArrow implements IProjectile, IThrowableEntity
{
    ...
    public EntityArrowPoison(World par1World, EntityLiving par2EntityLiving, EntityLiving par3EntityLiving, float par4, float par5)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
    ...
    public EntityArrowPoison(World par1World, EntityLiving par2EntityLiving, float par3)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.shootingEntity = par2EntityLiving;
        ...
        else
        {
            ...
            if (this.getIsCritical() && worldObj.isRemote)
            {
                for (l = 0; l < 4; ++l)
                {
                    ...
                    ParticleRegistry.spawnParticle("coloredcrit", worldObj, this.posX + this.motionX * (double)l / 4.0D, this.posY + this.motionY * (double)l / 4.0D, this.posZ + this.motionZ * (double)l / 4.0D, -this.motionX, -this.motionY + 0.2D, -this.motionZ, 0.5, 0.9, 0.5);
                }
            }
