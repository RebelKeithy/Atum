...
public class EntityFireSpearSeperated extends Entity implements IProjectile, IThrowableEntity
{
    ...
    public EntityFireSpearSeperated(EntityFireSpearCombined spear, float dmx, float dmy, float dmz)
    {
        ...
        //this.setThrowableHeading(this.motionX, this.motionY, this.motionZ, 0.9F * 1.5F, 1.0F);
    }
    ...
    public EntityFireSpearSeperated(World par1World, EntityLiving par2EntityLiving, EntityLiving par3EntityLiving, float par4, float par5)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
    ...
    public EntityFireSpearSeperated(World par1World, EntityLiving par2EntityLiving, float par3)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.shootingEntity = par2EntityLiving;
