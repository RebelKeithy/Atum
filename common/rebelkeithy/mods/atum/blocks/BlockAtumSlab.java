...
public class BlockAtumSlab extends BlockHalfSlab
{
    ...
    public Icon getBlockTextureFromSideAndMetadata(int par1, int par2)
    {
    	par2 = par2%4;
    	if(par2 == 0)
    		return Atum.atumStone.getBlockTextureFromSideAndMetadata(par1, par2 & 7);
    	else if(par2 == 1)
    		return Atum.atumCobble.getBlockTextureFromSideAndMetadata(par1, par2 & 7);
    	else if(par2 == 2)
    		return Atum.atumLargeBrick.getBlockTextureFromSideAndMetadata(par1, par2 & 7);

    	return Atum.atumSmallBrick.getBlockTextureFromSideAndMetadata(par1, par2 & 7);
