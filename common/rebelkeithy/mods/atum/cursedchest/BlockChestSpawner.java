...
public class BlockChestSpawner extends BlockContainer
{
    ...
    {
        TileEntityChestSpawner TileEntityChestSpawner = (TileEntityChestSpawner)par1World.getBlockTileEntity(par2, par3, par4);

        if (TileEntityChestSpawner != null)
        {
            for (int j1 = 0; j1 < TileEntityChestSpawner.getSizeInventory(); ++j1)
            {
                ItemStack itemstack = TileEntityChestSpawner.getStackInSlot(j1);
